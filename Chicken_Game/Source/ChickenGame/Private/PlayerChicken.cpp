...
//  add these
void APlayerChicken::Move(const FInputActionValue &Value) {
...
// Called every frame
void APlayerChicken::Tick(float DeltaTime) { Super::Tick(DeltaTime); }

// Called to bind functionality to input
void APlayerChicken::SetupPlayerInputComponent(
  ...
  if (UEnhancedInputComponent *EnhancedInputComponent =
    ...
    EnhancedInputComponent->BindAction(MovementAction, ETriggerEvent::Triggered,
                                       this, &APlayerChicken::Move);
    EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered,
                                       this, &APlayerChicken::Look);
    //  jumping
